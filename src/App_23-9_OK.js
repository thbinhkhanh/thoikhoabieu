...
import { usePrintTKB } from "./contexts/PrintTKBContext"; 
...
//import { saveTKB_Tudong } from "./utils/saveTKB_Tudong";
      ...
      <Box sx={{ pt: "100px", px: 2 }}>
        <Routes>
          ...
          <Route
            ...
            element={<XepTKB_GVCN setSaveHandler={setGvcnSaveHandler} />}
          />

          <Route
            path="/thoikhoabieu/gvbm"
            element={<XepTKB_GVBM setSaveHandler={setGvbmSaveHandler} />}
          />
